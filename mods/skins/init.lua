...
skins.update_player_skin = function(player)
	...
	if name ~= "Beerholder" and not skins.is_skin(skins.skins[name]) then
...
--	if player_name == "Beerholder" then
--		skins.skins[player_name] = skins.beerholder
--	end
