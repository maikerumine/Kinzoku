...
-- register bag tools
minetest.register_tool("unified_inventory:small", {
	description = "Small Bag",
	inventory_image = "bags_small.png",
	groups = {bagslots=8},
})
minetest.register_tool("unified_inventory:medium", {
	description = "Medium Bag",
	inventory_image = "bags_medium.png",
	groups = {bagslots=16},
})
minetest.register_tool("unified_inventory:large", {
...
minetest.register_craft({
	output = "unified_inventory:small",
	recipe = {
        {"", "default:steelblock_blue", ""},
        {"moreblocks:slab_steelblock_black_three_sides_u", "moreblocks:slab_steelblock_black_three_sides_u", "moreblocks:slab_steelblock_black_three_sides_u"},
        {"moreblocks:slab_steelblock_black_three_sides_u", "moreblocks:slab_steelblock_black_three_sides_u", "moreblocks:slab_steelblock_black_three_sides_u"},
    },
})
minetest.register_craft({
	output = "unified_inventory:medium",
	recipe = {
	{"default:steelblock_pink", "default:steelblock_pink", },
        {"unified_inventory:small", "unified_inventory:small"},
        {"unified_inventory:small", "unified_inventory:small"},
    },
})
minetest.register_craft({
	output = "unified_inventory:large",
	recipe = {
	{"default:steelblock", "default:steelblock", },
        {"unified_inventory:medium", "unified_inventory:medium"},
        {"unified_inventory:medium", "unified_inventory:medium"},
    },
})