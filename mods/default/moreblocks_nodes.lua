...
for name, def in pairs(nodes) do
	...
	minetest.register_alias(name, "default:" ..name)
	if not def.no_stairs then
		local groups = {}
		for k, v in pairs(def.groups) do groups[k] = v end
		stairsplus:register_all("moreblocks", name, "default:" ..name, {
...
minetest.register_craftitem("default:sweeper", {
	description = S("Sweeper"),
	inventory_image = "moreblocks_sweeper.png",
})

minetest.register_craftitem("default:nothing", {
