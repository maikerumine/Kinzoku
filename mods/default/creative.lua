...
default.init_creative_inventory = function(owner)
	...
	default.update_creative_inventory(owner_name)
...
function default.update_creative_inventory(player_name)
	local creative_list = {}
...
default.formspec_add = ""

default.set_creative_formspec = function(player, start_i)
	...
	player:set_inventory_formspec([[
		size[8,8.6]
		image[4.06,3.4;0.8,0.8;tnt_boom.png]
...
default.set_crafting_formspec = function(player)
	player:set_inventory_formspec([[
		size[8,8.6]
		...
		image[0.06,2.85;0.8,0.8;tnt_boom.png]
		image[5,1.75;1,1;tnt_boom.png^[transformR270]
...
minetest.register_on_joinplayer(function(player)
	...
	default.init_creative_inventory(player)
	default.set_creative_formspec(player, 0)
end)
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if fields.quit then
		if inv.tab_id == 1 then
			default.set_crafting_formspec(player)
		end
	elseif fields.creative_tabs then
		...
		if tab == 1 then
			...
			default.update_creative_inventory(player_name)
			default.set_creative_formspec(player, 0)
		end
	...
	elseif fields.creative_search then
		...
		default.set_creative_formspec(player, start_i)
	end
end)
