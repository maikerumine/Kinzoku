...
--mobs = {}
function default:register_mob(name, def)
...
function default:register_spawn(name, nodes, max_light, min_light, chance, active_object_count, max_height, min_height, spawn_func)
	default.spawning_mobs[name] = true
...
function default:register_arrow(name, def)
	minetest.register_entity(name, {
		physical = false,
		visual = def.visual,
		visual_size = def.visual_size,
