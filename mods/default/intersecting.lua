...
-- Nodes
--[[
minetest.register_node("default:luxore", {
	description = "Lux Ore",
...
minetest.register_craft({
    output = "default:light 8",
    recipe = {
        {"default:glass", "default:glass", "default:glass"},
        {"default:glass", "default:luxore", "default:glass"},
        {"default:glass", "default:glass", "default:glass"},
    },
})
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {"default:obsidian_glass", "default:luxore", "default:obsidian_glass"},
        {"default:obsidian_glass", "default:obsidian_glass", "default:obsidian_glass"},
    },
})
]]
...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	local c_dirt = minetest.get_content_id("default:steelblock_brown")
	local c_sand = minetest.get_content_id("default:steelblock_orange")
	local c_lava = minetest.get_content_id("default:lava_source")
	local c_grass = minetest.get_content_id("default:steelblock_dark_green")
	local c_tree = minetest.get_content_id("default:steelblock_brown")
	local c_jtree = minetest.get_content_id("default:steelblock_brown")
	local c_stone = minetest.get_content_id("default:steelblock_grey")
	local c_desertstone = minetest.get_content_id("default:steelblock_red")
	local c_sandstone = minetest.get_content_id("default:steelblock_yellow")
	local c_luxore = minetest.get_content_id("default:steelblock_pink")
